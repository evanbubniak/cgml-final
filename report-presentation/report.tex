...
\author{%
  Evan ~Bubniak\thanks{Work performed for Prof. Curro in partial fulfillment of the requirements of ECE-471, \emph{Computational Graphs in Machine Learning.} } \\
  Department of Mechanical Engineering\\
  The Cooper Union for the Advancement of Science and Art\\
  New York, NY 10003 \\
  \texttt{bubniak@cooper.edu} \\
